...
module.exports = "<ion-header>\n  <ion-toolbar color=\"primary\">\n    <ion-buttons slot=\"start\">\n      <ion-menu-button menu=\"m1\"></ion-menu-button>\n    </ion-buttons>\n    <ion-title>Analytics</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <h1 text-center>Analytics</h1>\n  <ion-card>\n    <ion-card-header text-center\n      >Average Complete Time by Nurse (in hours)</ion-card-header\n    >\n    <ion-card-content>\n      <canvas #valueBarsCanvas></canvas>\n    </ion-card-content>\n  </ion-card>\n  <ion-card>\n    <ion-card-header text-center\n      >Popular Request Types</ion-card-header\n    >\n    <ion-card-content>\n      <canvas #valueCommonCanvas></canvas>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n"
...
var AnalyticsPage = /** @class */ (function () {
    function AnalyticsPage(firestore) {
    ...
    AnalyticsPage.prototype.ngOnInit = function () {
        var _this = this;
        // get Nurses list
        this.nurseRef = this.firestore.collection('added-users', function (ref) {
            return ref.where('type', '==', 'n');
        });
        this.nurseRef.valueChanges().subscribe(function (result) {
            _this.nurses = result;
        });
        // get Completed Requests
        this.ref = this.firestore.collection('requests', function (ref) {
            return ref.where('status', '==', 'Completed');
        });
        this.ref.valueChanges().subscribe(function (result) {
            if (_this.chartData) {
                _this.updateCharts(result);
                _this.updateCommonCharts(result);
            }
            else {
                _this.createCharts(result);
                _this.createCommonChart(result);
            }
        });
    };
    AnalyticsPage.prototype.getReportValues = function () {
        var reportByNurse = {};
        var millisecondsPerHour = 1000 * 60 * 60;
        var counter;
        var sum;
        var avg;
        for (var _i = 0, _a = this.nurses; _i < _a.length; _i++) {
            var nurse = _a[_i];
            counter = 0;
            sum = 0;
            for (var _b = 0, _c = this.chartData; _b < _c.length; _b++) {
                var request = _c[_b];
    ...
    AnalyticsPage.prototype.getCommonReport = function () {
        var reportCommonRequest = {};
        for (var _i = 0, _a = this.commonChartData; _i < _a.length; _i++) {
            var request = _a[_i];
            reportCommonRequest[request.title] = 0;
        }
        for (var _b = 0, _c = this.commonChartData; _b < _c.length; _b++) {
            var request = _c[_b];
            reportCommonRequest[request.title] += 1;
        }
        return reportCommonRequest;
    };
    AnalyticsPage.prototype.createCharts = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var colors, i, chartData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        colors = [];
                        i = 0;
                        return [4 /*yield*/, this.getReportValues()];
                    case 1:
                        chartData = _a.sent();
                        ...
                        this.valueBarsChart = new chart_js__WEBPACK_IMPORTED_MODULE_3__["Chart"](this.valueBarCanvas.nativeElement, {
                            type: 'bar',
                            data: {
    ...
    AnalyticsPage.prototype.createCommonChart = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var colors, i, commonChartData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        colors = [];
                        i = 0;
                        return [4 /*yield*/, this.getCommonReport()];
                    case 1:
                        commonChartData = _a.sent();
                        while (i < this.getObjectSize(commonChartData)) {
                            colors.push(this.getRandomColor());
                            i += 1;
                        }
                        this.valueCommonChart = new chart_js__WEBPACK_IMPORTED_MODULE_3__["Chart"](this.valueCommonCanvas.nativeElement, {
                            type: 'bar',
                            data: {
    ...
    AnalyticsPage.prototype.updateCharts = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var chartData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    AnalyticsPage.prototype.updateCommonCharts = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var commonChartData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        commonChartData = _a.sent();
                        this.valueCommonChart.data.datasets.forEach(function (dataset) {
    ...
    AnalyticsPage.prototype.getRandomColor = function () {
    ...
    AnalyticsPage.prototype.getObjectSize = function (obj) {
        var size = 0, key;
        for (key in obj) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('valueBarsCanvas'),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], AnalyticsPage.prototype, "valueBarCanvas", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('valueCommonCanvas'),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], AnalyticsPage.prototype, "valueCommonCanvas", void 0);
